...
module Kapiqua25
  class Application < Rails::Application
    ...
    config.autoload_paths += %W( #{Rails.root}/lib #{Rails.root}/lib/validators #{Rails.root}/lib/helper_classes)
    ...
    config.cache_store = :redis_store, { :namespace => "Kapiqua25-#{Rails.env}" }
